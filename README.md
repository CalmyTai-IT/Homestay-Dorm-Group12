...
|----|------------------------------|------------|------------------------|
| **A** | Đăng ký thuê & lịch xem phòng | Đăng nhập/Phân quyền + Quản trị hệ thống | Hành trình đặt phòng & đăng nhập phía khách |
| **B** | Đặt cọc & xác nhận thuê (2 bước) | Xem giao dịch + nền backend/CSDL | Màn thanh toán cọc phía khách |
| **C** | Thuê nhóm & hủy/hoàn cọc trước thuê | Thông báo + định tuyến FE | Hủy đơn & tương tác khách |
| **D** | Ký hợp đồng & bàn giao phòng | Quản lý phòng/giường | Trang chủ & khung giao diện khách |
...
| 21120595 | Nguyễn Thành Vinh | _(điền A/B/C/D/E)_ |
